...
public class GetCampaignOverview {
  ...
  **/
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    ObjectUtils.equals(this.previewText, getCampaignOverview.previewText) &&
  ...
  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(id, name, subject, previewText, type, status, scheduledAt, abTesting, subjectA, subjectB, splitRule, winnerCriteria, winnerDelay, sendAtBestTime);
  }
